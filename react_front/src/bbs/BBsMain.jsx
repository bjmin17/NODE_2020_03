...
class BBsMain extends Component {
  ...
  */
  ...
  render() {
    ...
    //return <BBsList bbsList={this.state.bbsList} />;
  }

  // 서버로부터 데이터를 가져오는 method
...
/*
부모 컨테이너와 자식 컨테이너가 데이터를 주고 받는 형식

부모 >> 자식으로 일방통행 방식으로 데이터를 전달 할 수 있다.
부모 >> 자식으로 전달된 변수는 자식입장에서는 모두 props가 된다.

★ props 형태의 변수는 절대 변경할 수 없는 형태가 되고
