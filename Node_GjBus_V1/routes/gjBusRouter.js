...
module.exports = function(app,config){
    ...
    */
    ...
    // 사용할 수 있도록 초기화
    // 기본 limit를 10개로, 최대 limit를 50개로 설정
    app.use(paginate.middleware(10,50))

    // 한페이지에 몇개씩 보여줄것인가를 설정한 값
    const pageLimit = 10

    // 이하의 router method를 실행하기 전에
    // 먼저 실행하여 변수, 세팅 등을 설정한 후
        ...
        .exec(function(err,count){
            ...
            .exec(function(err,stations){
                ...
                res.render("gjbus/station",{
                    ...
                    // 아래 있는 코드가 중요, 자바에서 클래스를 만들어서 사용했었다.
                    pages:pageArray 
                })
            })
        })
    ...
    router.get("/getStation",function(req,res){
        ...
        request({
            url : url + queryParams,
            method : 'GET'
            // 위 url로 요청했을 때, 공공DB가 우리에게 주어질 매개변수들 3개(err,response,body)
        },function(err,response,body){
