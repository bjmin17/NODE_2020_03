...
/*
require() 확장모듈, 미들웨어 등을 import하는 명령함수
  ES5 이하에서 js파일을 외부에 분리하고
  실제사용할 때는 import 사용하는 방식
...
// router/photo/index.js를 import하라
var photoRouter = require("./routes/photo/photoRouter.js");
...
// spring에서 Controller 역항르 수행하는 모듈
app.use("/", indexRouter);
