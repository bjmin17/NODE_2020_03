...
// web의 request에 반응하는 이벤트 핸들러 라고 봐도 된다.
...
// web 브라우저에서
// localhost:3000/~~~/ 라고 path를 
//      enter를 눌러
//      요청하면 반응하는 이벤트 핸들러

// router.get() 요청은
//      callback 함수에게 req, res, next라고 하는
// 3개의 매개변수를 주입한다.
...
router.post("/insert",function(req,res){
    ...
    */
    ...
    // req.body를 주입하면
    // req.body의 데이터가 담긴
    // vo가 생성되고 생성된  vo를 save 메서드에 주입한다.
...
// id값을 path variable로 수신하여
// 데이터를 조회한 후 write폼으로 전송
router.get('/update/:id',function(req, res){
    ...
    bookVO.findOne({_id:id},function(err,data){
        // write라는 메서드로 bookVO라는 이름으로 data를 실어서 보내겠다.
        // res.json(data)
...
// RestFull 방식에서는
// update를 수행할때는 method=PUT 방식으로 하도록 권장한다.
// 내가 수행하고자 하는 일이 무엇인지
// 명확히 하고 싶다. 라는 의미
...
// RestFull 방식 권장사항 router.delete("/delete/:id")
